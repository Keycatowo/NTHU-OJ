...
class Vector {
 ...
 public:
  ...
  inline size_type capacity() const { return end_ - begin_; }
  inline size_type size() const { return last_ - begin_; }
  inline reference operator[](const size_type pos) { return begin_[pos]; }
